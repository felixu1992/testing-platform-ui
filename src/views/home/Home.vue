    ...
    <a-collapse default-active-key="1" :bordered="false">
      <a-collapse-panel key="1" header="数据统计">
        <a-row :gutter="16">
          <a-card>
            <a-col :span="8">
              <a-statistic title="项目数" :value="count.projectNum" style="margin-right: 50px" />
            </a-col>
            <a-col :span="8">
              <a-statistic title="接口数" :value="count.caseNum" class="demo-class" />
            </a-col>
            <a-col :span="8">
              <a-statistic title="记录数" :value="count.recordNum" class="demo-class" />
            </a-col>
          </a-card>
        </a-row>
        <a-row :gutter="16">
...
export default {
  ...
  methods:{
    initMarkdown: function () {
      this.used = markdown.HOW;
      this.desc = markdown.DESC;
    },
    statistics: function () {
