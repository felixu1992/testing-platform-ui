<template>
  <div class="update-project" style="padding:30px">
    ...
    <a-card title="编辑项目">
      <a-form id="update-project-form" :form="form" class="project-form" @submit="handleSubmit">
...
export default {
  ...
  methods: {
    ...
    getProject(id) {
      api.getProject(id, {}, data => this.form.setFieldsValue(data));
    },
    updateProject(id, params) {
      api.updateProject(id, params, data => this.$router.push('/project'));
    }
  },
  watch: {
    tabGroups: {
